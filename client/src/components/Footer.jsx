...
const Footer = () => {
  return (
        ...
        <div className="md:max-w-96">
           <img src={assets.logo} alt="logo" className="h-9"  />
            <p className="mt-6 text-sm">
                Experience the power of AI with QuickAi. <br /> Transform your content creation with our suite of premimum AI tools.Write articles,generate images, and enhance your workflow.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © Halima Yasmin. All Right Reserved.
    </p>
</footer>
  )
}
